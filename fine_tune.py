...
class Img_Classifier(object):
    ...
    def __init__(self, sz):
        ...
        self.name = ''.join(['cats_dogs', '_xception_finetune'])
    ...
    def get_model(self, dropout=False):
        ...
        base_model = Xception(include_top=False, weights='imagenet', input_shape=(
            self.img_rows, self.img_cols, self.img_ch), pooling=None)
        
        base_model.trainable = False

        for layer in base_model.layers[-self.unfreeze_last:]:
